...
| **3.2** | **Inductive Load Control — Interfacing the L293D Motor Driver Shield**<br>H-Bridge switching architecture, inductive back-EMF suppression, and state verification (Forward, Active Dynamic Brake, Reverse, Coasting Stop, PWM). | *(https://www.tinkercad.com/things/iKSMCzOMKdK-dc-motor-with-l293d-and-arduino)* |
...
| **3.4** | **Kinematic Maneuvers — 2-Wheel Robocar Basic Movements**<br>Differential drive kinematic motion primitives (Forward, Backward, Pivot Turns, Point Spins) executing an open-loop geometric demonstration. | *(https://www.tinkercad.com/things/2MrhkgLgUiQ-2-wheeled-robot)* |
| **3.5** | **Speed Vector Regulation — PWM Motor Control**<br>Pulse Width Modulation speed regulation, multi-tier speed presets, smooth acceleration/deceleration ramps to reduce inrush current, and differential trim calibration. | *(https://www.tinkercad.com/things/9QkFpe7W9eF-dc-motorspeed-controlvia-pwmpulse-width-modulation)* |
| **3.6** | **Wireless Kinematic – Bluetooth Interfacing**<br>Wireless teleoperation via HC-05/HC-06 Bluetooth module, case-insensitive RC protocol parser, speed scaling, and communication timeout auto-stop. | *([Dowanload NIELIT-Robotics-Controller.apk](https://github.com/lovnishverma/NIELIT-Robotics-Practicals/blob/main/examples/3_6_Wireless_Bluetooth_Kinematic/NIELIT-Robotics-Controller.apk))* |
