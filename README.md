...
| **3.7** | **Autonomous Line-Following Robot** | **L298N Module** | Closed-loop optical tracking with dual TCRT5000 IR reflectance sensors, discrete differential forward steering. | [Wiring Schematic](extras/Pinouts_and_Wiring_Guide.md#4-configuration-for-practicals-37--38-l298n-driver-module) |
...
* **Organization:** National Institute of Electronics & Information Technology (NIELIT) Ropar, Ministry of Electronics & Information Technology (MeitY), Government of India.
